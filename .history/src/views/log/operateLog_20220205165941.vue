  ...
  <div>
    ...
    >
      ...
      <el-table-column label="操作结果" width="170">
        <template v-slot="scope">
          <el-button v-if="scope.row.resultName == 1" type="primary" round>{{ scope.row.resultName }}</el-button>
          <el-button v-if="scope.row.resultName == 0" type="warning" round>{{ scope.row.resultName }}</el-button>
        </template>
      </el-table-column>
