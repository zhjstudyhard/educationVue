      ...
      <el-form :model="video" label-width="120px">
        ...
        <el-form-item label="上传视频">
          <el-upload
            ...
            :file-list="fileList"
            :action="'http://localhost:8089/api/video/uploadAlyiVideo'"
            :limit="1"
            class="upload-demo"
          >
...
export default {
  ...
  methods: {
    ...
    openEditChatper(chapterId) {
      ...
      //调用接口
      let data = { id: chapterId };
      chapter.getChapter(data).then((response) => {
    ...
    openEditVideo(videoId) {
      ...
      video.getVideo(data).then((response) => {
        ...
        let file = {name:this.video.videoOriginalName}
        this.fileList.push(file);
        console.log("集合：",this.fileList)
      });
    ...
    getChapterVideo() {
      ...
      chapter.getAllChapterVideo(data).then((response) => {
