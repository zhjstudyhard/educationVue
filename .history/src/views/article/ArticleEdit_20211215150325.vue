        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="分类" prop="cate">
               <el-select v-model="ruleForm.type" placeholder="请选择分类（输入可添加新分类）" style="width: 100%;">
              <!-- <el-select v-model="ruleForm.type" :allow-create="true" :filterable="true" placeholder="请选择分类（输入可添加新分类）" style="width: 100%;"> -->
                <el-option v-for="type in types" :key="type.dictionaryCode" :label="type.dictionaryValue" :value="type.dictionaryCode"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <!--标签，暂时未实现-->
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="浏览次数" prop="views">
              <el-input v-model="ruleForm.views" placeholder="请输入浏览次数（可选）默认为 0" type="number"></el-input>
            </el-form-item>
          </el-col>
          <!--是否公开-->
          <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    getTypes() {
      ...
      dictionary.queryDictionaryByType(data)
      .then((response) =>{
